...
<body>
	...
	<form action="./update" method="post" class="mx-3">
		...
		제목<input type="text" name="title" class="form-control" value="${notice.title}"><br>
		작성자<input type="text" readonly name="writer" class="form-control" value="${notice.writer}"><br>
